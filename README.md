...
2. Save the contribution data as a .csv file in the following format:
...
3. provide the following paramters: 
...
- write code that cleans donors with same name, city and candidate, but different address 
